...
const REGIONS = [
  // LEFT-side labels
  { id: 'scotland',   name: 'Scotland',           num: '15,860', trend: 'up',   detail: 'Concentrated pressure in Glasgow, Edinburgh and Dundee. Year-on-year increase in homelessness applications.', source: 'Scottish Government, 2024', url: 'https://www.gov.scot/publications/homelessness-in-scotland-2023-24/', dot: [510, 105], label: [180, 95],  side: 'left' },
  { id: 'ni',         name: 'Northern Ireland',   num: '3,500',  trend: 'up',   detail: 'NI Housing Executive remains the largest single landlord. Presentation rates have risen since 2022.',                source: 'NI DfC, 2024',              url: 'https://www.communities-ni.gov.uk/topics/homelessness',              dot: [335, 322], label: [180, 175], side: 'left' },
  ...
  { id: 'wales',      name: 'Wales',              num: '11,140', trend: 'down', detail: 'Welsh Government homelessness reform is in flight. Cardiff, Swansea and Newport carry the largest caseload.',          source: 'StatsWales, 2024',          url: 'https://www.gov.wales/homelessness-statistics',                       dot: [420, 345], label: [180, 335], side: 'left' },
