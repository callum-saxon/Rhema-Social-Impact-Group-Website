  ...
  return (
    ...
    >
      <g fill={`var(--primary, ${NAVY})`}>
        ...
        <path d="M 70 36 C 55 36, 47 50, 46 68 C 45 82, 48 94, 52 100 L 88 100 C 92 94, 95 82, 94 68 C 93 50, 85 36, 70 36 Z" />
        <ellipse cx="22" cy="38" rx="10" ry="11" />
        <path d="M 22 51 C 11 51, 5 63, 4 77 C 3 88, 5 96, 9 100 L 35 100 C 39 96, 41 88, 40 77 C 39 63, 33 51, 22 51 Z" />
        <ellipse cx="118" cy="38" rx="10" ry="11" />
        <path d="M 118 51 C 107 51, 101 63, 100 77 C 99 88, 101 96, 105 100 L 131 100 C 135 96, 137 88, 136 77 C 135 63, 129 51, 118 51 Z" />
      </g>
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <g fill="#FFFFFF">
        ...
        <path d="M 32 30 C 23 30, 19 39, 18.5 49 C 18.2 55, 19.5 60, 21 62 L 43 62 C 44.5 60, 45.8 55, 45.5 49 C 45 39, 41 30, 32 30 Z" />
      </g>
